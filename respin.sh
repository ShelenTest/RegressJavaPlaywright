...
mvn test -Dgroups=base,cards,loginHeader,chat,loginWithUnconfirmedEmail,affiliate,transactions,creditCard,bonus,demo,manualVerification,noSport,customer
