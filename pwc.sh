...
mvn test -DskinName="pwc" -Dgroups=base,cards,regWithPersonalInfo,noLoginWihtUnconfirmedEmail,affiliate,transactions,GTM,creditCard,bonus,demo,verification,noSport
